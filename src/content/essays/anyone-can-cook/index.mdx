...
date: 2026-04-12
summary: AI is collapsing the boundary between having a vision and shipping it. The essay behind this site’s name — and its philosophy.
featured: true
---
...
<p class="note">Written about the first version of this site. It has since been redesigned — same hands, same philosophy.</p>
...
The normal route would've been: research static site generators, pick one, follow a tutorial, get stuck on step 7, Google the error, find a Stack Overflow answer from 2019, realise it's outdated, try a different tutorial. You know the loop. I've been in it before. Months of "learning" and nothing shipped.
...
The collaboration wasn't one-directional. I gave Claude direction as often as it gave me suggestions. It proposed Astro — I pushed back on colour choices. It suggested a layout — I said no, simpler. It built a feature — I said actually, I don't want that, try this instead.
